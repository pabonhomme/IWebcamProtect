...
{
    public abstract class IWebcamProtectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IWebcamProtectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IWebcamProtectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IWebcamProtectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IWebcamProtectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IWebcamProtectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IWebcamProtectDbContext, Task<T>> func)
        {
            T result;
