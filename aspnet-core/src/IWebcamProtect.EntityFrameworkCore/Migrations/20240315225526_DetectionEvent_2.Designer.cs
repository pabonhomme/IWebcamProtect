...
namespace IWebcamProtect.Migrations
{
    ...
    [Migration("20240315225526_DetectionEvent_2")]
    partial class DetectionEvent_2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IWebcamProtect.Models.Camera", b =>
                {
                    ...
                    b.Property<DateTime?>("WatchTimeStart")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("IWebcamProtect.Models.EntityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("IWebcamProtect.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("IWebcamProtect.Authorization.Users.User", null)
                        .WithMany("Claims")
